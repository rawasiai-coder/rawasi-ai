export default function Nav() {
  return (
    <nav className="fixed inset-x-0 top-0 z-50 flex items-center gap-4 border-b border-[var(--line)] bg-[rgba(246,245,248,.82)] px-7 py-3.5 backdrop-blur-[14px]">
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/brand/rawasi-mark-black.svg" alt="رواسي" className="h-[26px]" />
