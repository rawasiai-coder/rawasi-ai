...
const FAQS = [
  {
    ...
    a: "جلسة تشخيص ٣٠ دقيقة نفهم فيها عملياتكم ونحدّد أين تكمن الخسارة. تخرجون منها بخطة واضحة سواء عملنا معاً أو لا.",
  },
  {
    ...
    <section id="faq" className="rv mx-auto max-w-[860px] px-6 py-24">
      ...
      <div className="mt-9 space-y-3">
        {FAQS.map((f) => (
          <details
            key={f.q}
            className="group rounded-xl border border-[var(--line)] bg-[var(--color-panel)] px-5 open:border-white/25"
          >
