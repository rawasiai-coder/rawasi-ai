  ...
  return (
    <section className="rv border-y border-[var(--line)] bg-[#EFEEF3]">
      <div className="mx-auto max-w-[1120px] px-6 py-24">
        ...
        <div className="mt-9 grid items-start gap-[18px] sm:grid-cols-2 lg:grid-cols-3">
          {QUOTES.map((t) => (
            <figure
              key={t.co}
              className="lift rounded-2xl border border-[var(--line)] bg-white p-6 shadow-[0_1px_3px_rgba(20,22,26,.06)]"
            >
              <div className="mb-5 inline-flex rounded-full bg-[rgba(0,163,224,.10)] px-3 py-1 text-[12.5px] font-bold text-[var(--color-blue)] en">
                {t.co}
              </div>

              <blockquote className="text-[15px] leading-relaxed text-[rgba(20,22,26,.82)]">
                «{t.q}»
              </blockquote>
